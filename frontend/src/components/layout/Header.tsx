...
const routeTitles: Record<string, { title: string; subtitle: string }> = {
  '/dashboard': { title: 'Cruscotto', subtitle: 'Panoramica operativa e scadenze principali' },
  '/hr': { title: 'Persone', subtitle: 'Personale interno, collaboratori esterni e fascicoli' },
  '/hr/interna': { title: 'Personale interno', subtitle: 'Dipendenti e fascicoli aziendali' },
  '/hr/esterna': { title: 'Personale esterno', subtitle: 'Collaboratori, consulenti e organizzazioni collegate' },
  '/hr/new': { title: 'Nuova persona', subtitle: 'Inserimento anagrafica e dati di base' },
  '/fleet': { title: 'Mezzi', subtitle: 'Parco macchine, coperture, revisioni e assegnazioni' },
  '/fleet/anagrafica': { title: 'Tutti i mezzi', subtitle: 'Archivio operativo con stato, scadenze e fascicoli' },
  ...
  '/aib': { title: 'AIB', subtitle: 'Antincendio boschivo, squadre e interventi' },
  '/aib/map': { title: 'Mappa squadre AIB', subtitle: 'Posizioni in tempo reale' },
  '/operations': { title: 'Sale operative', subtitle: 'Monitoraggio e coordinamento operativo' },
  '/tools': { title: 'Strumenti', subtitle: 'Utilità trasversali e moduli di supporto' },
  '/tools/geography': { title: 'Geografia', subtitle: 'Stati, regioni, province, comuni e layer territoriali' },
  '/tools/codice-fiscale': { title: 'Codice fiscale', subtitle: 'Generazione e lettura inversa del codice fiscale' },
  '/admin': { title: 'Amministrazione', subtitle: 'Gestione sistema e utenti' },
  '/admin/contracts': { title: 'Contratti', subtitle: 'CCNL, integrativi e regole base di sistema' },
  '/admin/geography': { title: 'Geografia', subtitle: 'Stati, regioni, province, comuni e layer territoriali' },
  '/admin/pending': { title: 'Accessi in attesa', subtitle: 'Richieste da verificare e approvare' },
  '/admin/users': { title: 'Utenti', subtitle: 'Account, stati e permessi assegnati' },
  '/admin/roles': { title: 'Ruoli e permessi', subtitle: 'Profili di accesso e privilegi' },
  '/admin/organizations': { title: 'Sedi e strutture', subtitle: 'Distretti, reparti e articolazioni aziendali' },
  '/admin/logs': { title: 'Log di sistema', subtitle: 'Registro operazioni e audit trail' },
  '/admin/settings': { title: 'Impostazioni', subtitle: 'Configurazioni, integrazioni e API' },
